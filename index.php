...
<html lang="en">
	...
	<body>
		<div class="container">
			...
			<div class="row" id="body">
				<div class="col-md-9">
					<img class="img-thumbnail" src="images/purchase.jpg" height="400px" width="300px" style="margin:10px;float:left;"/>
				...
				<div class="links" style="margin-top:30px;width:25%;float:right;">
						...
						<div style="margin-top:5px;margin-right:3%;border-radius:2px;height:35px;background:#E73838;padding:3px;color:white;font-size:18px;text-align:center;">DATABASE</div>
	...
	e="margin-top:5px;margin-right:3%;border-radius:2px;height:35px;background:#85adad;padding:3px;color:white;font-size:18px;text-align:center;">NIT SILCHAR</div>
						<div style="margin-top:5px;margin-right:3%;border-radius:2px;height:35px;background:#E73838;padding:3px;color:white;font-size:18px;te
</html>